...
import to.joeli.jass.client.game.strategy.helpers.ShellScriptRunner;
...
public class NeuralNetwork {
	...
	private static String getPythonDirectory() {
		return System.getProperty("user.dir") + "/src/main/java/com/joeli/jass/client/game/strategy/training/python";
	}
