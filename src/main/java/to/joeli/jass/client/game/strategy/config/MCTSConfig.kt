package to.joeli.jass.client.game.strategy.config

import to.joeli.jass.client.game.strategy.mcts.src.FinalSelectionPolicy
import to.joeli.jass.client.game.strategy.mcts.src.HeuristicFunction
