...
public class JassBoardTest {
	...
	public void testGetMoves() {
		for (int i = 0; i < 100; i++) {
			JassBoard jassBoard = JassBoard.constructCardSelectionJassBoard(cards1, diamondsGame, false, null, null);
	...
	public void testGetMovesObeAbe() {
		for (int i = 0; i < 100; i++) {
			JassBoard jassBoard = JassBoard.constructCardSelectionJassBoard(cards1, obeAbeGame, false, null, null);
			jassBoard.sampleCardDeterminizationToPlayersInCardPlay();
	...
	public void testGetMovesNeverReturnsEmptyArrayList() {
		for (int i = 0; i < 100; i++) {
			...
			jassBoard.sampleCardDeterminizationToPlayersInCardPlay();
			// should not get filtered
			JassBoard jassBoard2 = JassBoard.constructCardSelectionJassBoard(CardKnowledgeBase.pickRandomSubSet(allCards, 9), obeAbeGame, false, null, null);
